...
const Header = () => {
  ...
  <Navbar  variant="light" fixed='top' className='top-nav mb-3'>
   ...
   <Marquee className='marque-text' gradient={false}><Navbar.Brand href="#"><img src='images/event.gif'></img><span className='offer-text'>Check Offers click here</span></Navbar.Brand></Marquee>
    </Nav>
